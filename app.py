...
AVAILABLE_FIELDS = {
    ...
    "tot_coll_amt": {"label": "Total Collections Amount ($)", "type": "number", "min": 0, "max": 50000, "default": 0},

    # --- Borrower income & employment ---
    "annual_inc": {"label": "Annual Income ($)", "type": "number", "min": 0, "max": 350000, "default": 60000},
    ...
    "revol_bal": {"label": "Revolving Balance ($)", "type": "number", "min": 0, "max": 100000, "default": 15000},
    "revol_util": {"label": "Revolving Utilization (%)", "type": "number", "min": 0, "max": 150, "default": 50},
    "total_rev_hi_lim": {"label": "Total Revolving Credit Limit ($)", "type": "number", "min": 0, "max": 200000, "default": 30000},
    ...
    # CHANGED: max was hardcoded to 2018 (the training dataset's last year), which made it
    # impossible to enter a real, current-day borrower's earliest credit line year.
    # Now tracks the actual current year.
    "earliest_cr_line": {"label": "Credit History Start Year", "type": "number", "min": 1950, "max": CURRENT_YEAR, "default": 2000},
    ...
    "tot_cur_bal": {"label": "Total Current Balance Across Accounts ($)", "type": "number", "min": 0, "max": 750000, "default": 50000},
    "tot_hi_cred_lim": {"label": "Total High Credit Limit ($)", "type": "number", "min": 0, "max": 750000, "default": 100000},
    "avg_cur_bal": {"label": "Average Current Balance per Account ($)", "type": "number", "min": 0, "max": 100000, "default": 10000},
    "acc_open_past_24mths": {"label": "Accounts Opened in Last 24 Months", "type": "number", "min": 0, "max": 25, "default": 3},

    # --- Recent activity ---
    "total_bal_ex_mort": {"label": "Total Balance Excluding Mortgage ($)", "type": "number", "min": 0, "max": 300000, "default": 30000},
    "total_bc_limit": {"label": "Total Bankcard Credit Limit ($)", "type": "number", "min": 0, "max": 150000, "default": 20000},
    "bc_open_to_buy": {"label": "Available Bankcard Credit ($)", "type": "number", "min": 0, "max": 150000, "default": 8000},
    ...
    # CHANGED: max reduced from 900 (75 years) to a more plausible ceiling for a
    # borrower's oldest revolving account.
    "mo_sin_old_rev_tl_op": {"label": "Months Since Oldest Revolving Account Opened", "type": "number", "min": 0, "max": 700, "default": 180},
    "mo_sin_old_il_acct": {"label": "Months Since Oldest Installment Account Opened", "type": "number", "min": 0, "max": 750, "default": 125},
    # CHANGED: this is "most recent" account activity — a 400-month (33-year) ceiling
    # doesn't fit that meaning. Tightened to 200.
    "mo_sin_rcnt_rev_tl_op": {"label": "Months Since Most Recent Revolving Account Opened", "type": "number", "min": 0, "max": 200, "default": 13},
    "mo_sin_rcnt_tl": {"label": "Months Since Most Recent Account Opened", "type": "number", "min": 0, "max": 250, "default": 8},
    # CHANGED: same "most recent" reasoning — reduced from 650 to 300.
    "mths_since_recent_bc": {"label": "Months Since Most Recent Bankcard Opened", "type": "number", "min": 0, "max": 300, "default": 24},
    ...
    # CHANGED: "most recent" installment account — reduced from 350 to 200.
    "mths_since_rcnt_il": {"label": "Months Since Most Recent Installment Account", "type": "number", "min": 0, "max": 200, "default": 21},
    "total_bal_il": {"label": "Total Installment Balance ($)", "type": "number", "min": 0, "max": 300000, "default": 35000},
    ...
    "max_bal_bc": {"label": "Highest Bankcard Balance ($)", "type": "number", "min": 0, "max": 50000, "default": 5700},
    ...
    "total_il_high_credit_limit": {"label": "Total Installment Credit Limit ($)", "type": "number", "min": 0, "max": 500000, "default": 40000},
}
